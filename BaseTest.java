...
public class BaseTest {
	...
	home.ClickonProductImage(); Thread.sleep(3000);
	//To check whether the Product Image page is opened so checking the title of that page
	...
	home.EnterSerachEle(); Thread.sleep(2000);
